...
const errors:{[x: string]: ResponseApi<undefined>}={
    ...
    'Role not found': {code: 404, error: true, message: 'Role not found'},
    'User not found': {code: 404, error: true, message: 'User not found'},
    'Order not found': {code: 404, error: true, message: 'Order not found'},
    ...
    'Error saving discount': {code: 500, error: true, message: 'Error saving discount'},
    'Error saving order': {code: 500, error: true, message: 'Error saving order'},
    'Error updating order': {code: 500, error: true, message: 'Error updating order'},
