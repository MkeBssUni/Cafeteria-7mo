    ...
    <>
      <div className="carrusel-foto">
        <Carousel>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h2>SICAF</h2>
              <p><b>Donde el café caliente encuentra su hogar y tu corazón encuentra su refugio.</b></p>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h2>SICAF</h2>
              <p><b>Las mejores ofertas en postres siempre se han encontrado aquí</b></p>
      ...
      <div>
        <Row  className="d-flex justify-content-center
            ...
            <Card body>
                <h5> <SvgIcon component={PlaceIcon} inheritViewBox />C. Gutemberg 2, Cuernavaca Centro, Centro, 62000 Cuernavaca, Mor.</h5>
                <h5> <SvgIcon component={InstagramIcon} inheritViewBox />SICAF</h5>
                <h5> <SvgIcon component={FacebookIcon} inheritViewBox />SICAF</h5>
            </Card>
            </Col>
