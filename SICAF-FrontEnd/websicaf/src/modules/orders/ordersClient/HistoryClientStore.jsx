...
import GetUserHistory from "../Functions/GetUserHistory";
...
const HistoryClientStore = () => {
  ...
  const getPedidos = async (newInitialValue) => {
    try {
      ...
      const data = await GetUserHistory(initialValues);
      setpedidos(data);
    } catch (error) {
...
export default HistoryClientStore