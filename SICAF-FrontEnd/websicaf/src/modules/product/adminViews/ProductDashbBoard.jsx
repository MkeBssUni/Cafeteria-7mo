                ...
                >
                  ...
                  >
                    <Card.Body>
                      ...
                      />
                      <b>
                        <p className="info_products_offers_admin mt-3">
                      ...
                      {product.discount_id ? (
                        ...
                        <p className="info_products_offers_admin error-text">
                          Sin descuento
                        </p>
                      )}
                        ...
                        <Col>
                          ...
                          >
                            <Button
                              ...
                              onClick={() =>
                                changeStatus(product.id, product.status)
                              }
                            >
                              {product.status ? (
                                <>
